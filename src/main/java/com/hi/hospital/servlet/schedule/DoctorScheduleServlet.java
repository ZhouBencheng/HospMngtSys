package com.hi.hospital.servlet.schedule;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.pagehelper.PageInfo;
import com.hi.hospital.entity.DoctorSchedule;
import com.hi.hospital.service.DoctorScheduleServiceImpl;
...
public class DoctorScheduleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        PageInfo<DoctorSchedule> pageInfo = service.queryByPage(i, 5, date, shiftTime, deptId == null ? null : Integer.parseInt(deptId));
